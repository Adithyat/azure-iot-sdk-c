...
static const char *connectionString = "HostName=iot-danadf-dev.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=iqncCOlmz0LBLEsq4Dp23yV+0F0yr4ffm1NgFzVboDA=";
